...
func TestBuiltinType(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Int", &ast.BuiltinType{Kind: ast.Int}, "int32", false},
		{"UInt", &ast.BuiltinType{Kind: ast.Int, Flags: ast.Unsigned}, "uint32", false},
		{"Long", &ast.BuiltinType{Kind: ast.Int, Flags: ast.Long}, "int64", false},
		{"ULong", &ast.BuiltinType{Kind: ast.Int, Flags: ast.Long | ast.Unsigned}, "uint64", false},
		{"LongLong", &ast.BuiltinType{Kind: ast.Int, Flags: ast.LongLong}, "int64", false},
		{"ULongLong", &ast.BuiltinType{Kind: ast.Int, Flags: ast.LongLong | ast.Unsigned}, "uint64", false},

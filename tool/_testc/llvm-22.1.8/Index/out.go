...
func (CTUnit *TranslationUnitImpl) TranslationUnitSpelling() CXString.String {
...
func (Info *TargetInfoImpl) TargetInfoGetTriple() CXString.String {
	return CXString.String{}
}
...
func (_llcppg_param1 *TranslationUnitImpl) Cursor(_llcppg_param2 CXSourceLocation.SourceLocation) Cursor {
	return Cursor{}
}
